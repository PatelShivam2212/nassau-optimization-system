...
urlpatterns = [
    ...
    # --- NEW: Master Data Endpoints ---
    path('factories/', views.factory_list_api, name='factory_list_api'),
    path('correlations/', views.product_correlation_api, name='product_correlation_api'),

    # --- NEW: Filter Data and KPIs ---
    path('regions/', views.get_regions, name='regions'),
    path('ship_modes/', views.get_ship_modes, name='ship_modes'),
    path('coverage/', views.coverage_kpi, name='coverage_kpi'),
]